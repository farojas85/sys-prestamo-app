...
const {
    form, dato, roles, errors, respuesta, role,
    listar, buscar, isActived, pagesNumber, cambiarPaginacion, cambiarPagina,
    limpiar, obtenerRole, eliminarRole, inhabilitarRole,
    habilitarRole
} = useRole();
...
const nuevo = () => {
    ...
    (
        document.getElementById('modal-role-title')
    ).innerHTML ="Nuevo Rol";
...
const inhabilitar = (id) => {
        Swal.fire({
        //title: 'Grados Ministeriales',
        title:'¿Está seguro de inhabilitar el Rol?',
        icon:'question',
        confirmButtonColor: "#28a745",
        confirmButtonText: "Si",
        showCancelButton: true,
...
<template>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-sm">
                            ...
                            <tbody>
                                ...
                                <tr v-else v-for="(tipo,index) in roles.data">
                                    <td v-text="index+roles.from"></td>
    ...
    <RoleForm :form="form" @onListar="listar"></RoleForm>
</template>