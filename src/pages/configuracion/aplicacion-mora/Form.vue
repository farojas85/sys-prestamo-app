...
const {
    errors, respuesta,
    agregarAplicacionMora, actualizarAplicacionMora
} = useAplicacionMora();
...
const crud = {
    'nuevo': async() => {
        ...
        form.value.errors = [];
        await agregarAplicacionMora(form.value);
        ...
        if(respuesta.value.ok==1)
        {
            ...
            $('#modal-aplicacion-mora').modal('hide')
            emit('onListar')
        }
    },
    'editar': async() => {
        form.value.errors = [];
        await actualizarAplicacionMora(form.value);
...
<form @submit.prevent="guardar">
    <div class="modal fade" id="modal-aplicacion-mora">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-aplicacion-mora-title">Nuevo Tipo de Actividad</h6>
