...
const {
    errors, respuesta,
    agregarAplicacionIntereses, actualizarAplicacionInteres
...
const crud = {
    'nuevo': async() => {
        ...
        form.value.errors = [];
        await agregarAplicacionIntereses(form.value);
        ...
        if(respuesta.value.ok==1)
        {
            ...
            $('#modal-aplicacion-interes').modal('hide')
            emit('onListar')
        }
    },
    'editar': async() => {
        form.value.errors = [];
        await actualizarAplicacionInteres(form.value);
...
<form @submit.prevent="guardar">
    <div class="modal fade" id="modal-aplicacion-interes">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-aplicacion-interes-title">Nuevo Tipo de Actividad</h6>
